...
- Integrated with Google Analytics; Google Search Console; Localization(Custom Tagalog and English); CI/CD Pipelines; optimized SEO, standalone CMS(Firebase); Redux; and <b>D A R K M O D E</b>!
- and more!

...
const GOOGLE_DOCS_LINK = 'https://drive.google.com/file/d/1_FB2OYWS_M9x3gVthZREYOw8pqLw00Xi';
...
const ResumePage = () => {
  ...
  return (
    <div className="resume-section flex flex-col items-center lg:justify-center justify-around min-h-screen py-20">
      ...
      <iframe src={`${GOOGLE_DOCS_LINK}/preview`} width="90%" height="900" allow="autoplay" className='mb-8'></iframe>
